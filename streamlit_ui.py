...
def build_hinglish_command(table1, col1, table2, col2, join_type):
    ...
    command = f"{table1} aur {table2} ko {table1}.{col1} = {table2}.{col2} par {join_keyword} karke dikha"
    return command
...
with st.sidebar:
    ...
    if not tables:
        ...
        hinglish_cmd = build_hinglish_command(table1, col1_selected, table2, col2_selected, join_type)
...
if "last_output" not in st.session_state:
    ...
    with tab2:
        ...
        **Command Syntax:**
        ```
        <table1> aur <table2> ko <table1>.<column1> = <table2>.<column2> par <inner|left> join karke dikha
        ```
...
with st.expander("📚 Example Commands"):
    ...
    **LEFT JOIN Example:**
    ...
    ```
    Shows all students, with marks if available (NULL otherwise).
    """)
